...
var processEmoteRegExp = function(str) {
	...
	str = str.replace(/\b(tppPokeball|tppHelix|tppRng|tppPokeyen|tppCrit|tppHax|tppMiss|tppPc|tppRiot|tppDome|tppCursor|tppTrumpet|tppFogChamp|tppSlowpoke|tppHappy|tppLUL)\b/g,

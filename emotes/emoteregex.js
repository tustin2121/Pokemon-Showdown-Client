...
var processEmoteRegExp = function(str) {
	...
	str = str.replace(/&lt;3\b/g, 
		'<img src="/emotes/_robot/heart.png" alt="&lt;3" title="&lt;3" class="emote">');
	// -global emotes
	str = str.replace(/\b(4Head|AMPEnergy|AMPEnergyCherry|AMPTropPunch|ANELE|ArgieB8|ArsonNoSexy|AsianGlow|AthenaPMS|BabyRage|BatChest|BCouch|BCWarrior|BibleThump|BigBrother|BlargNaut|bleedPurple|BloodTrail|BORT|BrainSlug|BrokeBack|BudBlast|BuddhaBar|BudStar|ChefFrank|cmonBruh|CoolCat|CoolStoryBob|copyThis|CorgiDerp|CurseLit|DAESuppy|DansGame|DatSheffy|DBstyle|deIlluminati|DendiFace|DogFace|DoritosChip|duDudu|DxAbomb|DxCat|EagleEye|EleGiggle|FailFish|FPSMarksman|FrankerZ|FreakinStinkin|FUNgineer|FunRun|FutureMan|GingerPower|GivePLZ|GOWSkull|GrammarKing|HassaanChop|HassanChop|HeyGuys|HotPokket|HumbleLife|imGlitch|ItsBoshyTime|Jebaited|JKanStyle|JonCarnage|KAPOW|Kappa|KappaClaus|KappaPride|KappaRoss|KappaWealth|Keepo|KevinTurtle|Kippa|Kreygasm|Mau5|mcaT|MikeHogu|MingLee|MrDestructoid|MVGame|NervousMonkey|NinjaTroll|NomNom|NoNoSpot|NotATK|NotLikeThis|OhMyDog|OMGScoots|OneHand|OpieOP|OptimizePrime|OSfrog|OSkomodo|OSsloth|panicBasket|PanicVis|PartyTime|pastaThat|PeoplesChamp|PermaSmug|PeteZaroll|PeteZarollTie|PicoMause|PipeHype|PJSalt|PJSugar|PMSTwin|PogChamp|Poooound|PraiseIt|PRChase|PrimeMe|PunchTrees|PuppeyFace|RaccAttack|RalpherZ|RedCoat|ResidentSleeper|riPepperonis|RitzMitz|RuleFive|SeemsGood|SGlemon|SGmouth|SGrasp|ShadyLulu|ShazBotstix|SmoocherZ|SMOrc|SoBayed|SoonerLater|SSSsss|StinkyCheese|StoneLightning|StrawBeary|SuperVinlin|SwiftRage|TakeNRG|TBCheesePull|TBTacoLeft|TBTacoRight|TF2John|TheRinger|TheTarFu|TheThing|ThunBeast|TinyFace|TooSpicy|TriHard|TTours|twitchRaid|TwitchRPG|UleetBackup|UncleNox|UnSane|VoHiYo|VoteNay|VoteYea|WholeWheat|WTRuck|WutFace|YouWHY)\b/g,

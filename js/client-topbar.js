(function ($) {
	...
	var Topbar = this.Topbar = Backbone.View.extend({
		...
		initialize: function () {
			...
			this.$el.html('<img class="logo" src="tppleague.png" alt="TPPLeague" width="184" height="40" /><div class="maintabbarbottom"></div><div class="tabbar maintabbar"><div class="inner"></div></div><div class="userbar"></div>');
		...
		renderRoomTab: function (room, id) {
			...
			case 'leaguebuilder':
				return buf + '><i class="fa fa-sitemap"></i> <span>TPPLeague</span></a><button class="closebutton" name="closeRoom" value="leaguebuilder"><i class="fa fa-times-circle"></i></button></li>';
			case 'ladder':
		...
		updateTabbar: function () {
			...
			var buf = '<ul>' + this.renderRoomTab(app.rooms['']) + this.renderRoomTab(app.rooms['teambuilder']) + this.renderRoomTab(app.rooms['ladder']) /*+ this.renderRoomTab(app.rooms['leaguebuilder'])*/ + '</ul>';
			var sideBuf = '';

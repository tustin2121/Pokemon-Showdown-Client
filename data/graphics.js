...
var BattleBackdrops = {
	...
	3: [
		'gen3/bg-gen3.png',
		'gen3/bg-gen3-cave.png',
		'gen3/bg-gen3-ocean.png',
		'gen3/bg-gen3-sand.png',
		'gen3/bg-gen3-forest.png',
		'gen3/bg-gen3-arena.png'
	],
	4: [
		'gen4/bg-gen4.png',
		'gen4/bg-gen4-cave.png',
		'gen4/bg-gen4-snow.png',
		'gen4/bg-gen4-indoors.png',
		'gen4/bg-gen4-water.png'
	],
	5: [
		'gen5/bg-beach.png',
		'gen5/bg-beachshore.png',
		'gen5/bg-desert.png',
		'gen5/bg-meadow.png',
		'gen5/bg-thunderplains.png',
		'gen5/bg-city.png',
		'gen5/bg-earthycave.png',
		'gen5/bg-mountain.png',
		'gen5/bg-volcanocave.png',
		'gen5/bg-dampcave.png',
		'gen5/bg-forest.png',
		'gen5/bg-river.png',
		'gen5/bg-deepsea.png',
		'gen5/bg-icecave.png',
	...
	6: [
		"gen6/bg-beach.jpg",
		"gen6/bg-beach2-night.jpg",
		"gen6/bg-beach2.jpg",
		"gen6/bg-bridge.png",
		"gen6/bg-cave.png",
		"gen6/bg-cave3.png",
		// "gen6/bg-ceremony.png",
		// "gen6/bg-champion.png",
		// "gen6/bg-championxy.png",
		"gen6/bg-city-night.png",
		"gen6/bg-city.jpg",
		"gen6/bg-city2-night.jpg",
		"gen6/bg-city3.png",
		"gen6/bg-cycling.png",
		"gen6/bg-dampcave.jpg",
		"gen6/bg-darkmeadow.jpg",
		// "gen6/bg-deepsea.jpg",
		"gen6/bg-desert.jpg",
		// "gen6/bg-e4-drake.jpg",
		// "gen6/bg-e4-drasna.png",
		// "gen6/bg-e4-glacia.png",
		// "gen6/bg-e4-malva.png",
		// "gen6/bg-e4-phoebe.png",
		// "gen6/bg-e4-siebold.png",
		// "gen6/bg-e4-sydney.png",
		"gen6/bg-earthycave.jpg",
		// "gen6/bg-fairymist.png",
		// "gen6/bg-flowerfield.png",
		"gen6/bg-forest.jpg",
		"gen6/bg-grass-autumn.png",
		"gen6/bg-grass-evening.png",
		"gen6/bg-grass-night.png",
		"gen6/bg-grass.png",
		// "gen6/bg-grassyterrain.png",
		"gen6/bg-gravetower.png",
		"gen6/bg-icecave.jpg",
		"gen6/bg-indoors.png",
		"gen6/bg-indoors2.png",
		// "gen6/bg-leader-brawly.png",
		// "gen6/bg-leader-flannery.png",
		// "gen6/bg-leader-grant.png",
		// "gen6/bg-leader-korrina.png",
		// "gen6/bg-leader-norman.png",
		// "gen6/bg-leader-olympia.png",
		// "gen6/bg-leader-viola.png",
		// "gen6/bg-leader-wallace.jpg",
		// "gen6/bg-leader-wattson.png",
		// "gen6/bg-leader-winona.png",
		"gen6/bg-library.jpg",
		"gen6/bg-maison.png",
		"gen6/bg-meadow-night.jpg",
		"gen6/bg-meadow.jpg",
		"gen6/bg-rocky-evening.png",
		"gen6/bg-rocky.jpg",
		"gen6/bg-rocky2.png",
		"gen6/bg-sea.jpg",
		"gen6/bg-sea2.png",
		"gen6/bg-skybattle.png",
		// "gen6/bg-skypillar.jpg",
		"gen6/bg-snow.jpg",
		"gen6/bg-sooty-evening.png",
		"gen6/bg-sooty.png",
		// "gen6/bg-sterile.png",
		// "gen6/bg-sun.png",
		"gen6/bg-volcano.png",
		"gen6/bg-wifi.jpg",
		// "gen6/bg-xerneasglenn.png",
		// "gen6/bg.png",
	],
};
...
var BattleMoveAnims = {
	...
	infernooverdrive: {
		anim: function (battle, args) {
			...
			battle.backgroundEffect('#B84038', 800, 0.7);
			battle.backgroundEffect('#ffffff', 200, 0.7, 700);
			battle.backgroundEffect('#000000', 800, 0.7, 900);
			battle.showEffect('fireball', {
				x: attacker.x,
	...
	pulverizingpancake: {
		anim: function (battle, args) {
			...
			battle.backgroundEffect('#000000', 600, 0.7, 1200);
			battle.showEffect('electroball', {
				x: defender.x,
				y: defender.y - 60,
				z: defender.z,
